...
import com.example.udhar.AllMemberLists.AllMember;
import com.example.udhar.AllMemberLists.AllMembersAdapter;
...
public class AllMembers extends AppCompatActivity {
    ...
    private void MyRecyclerView() {
        ...
        cList = new ArrayList<>();
        mAdapter = new AllMembersAdapter(this,cList);
    ...
    private void GetData() {
        ...
        RequestQueue queue = Volley.newRequestQueue(AllMembers.this);
        StringRequest postRequest = new StringRequest(Request.Method.POST,BaseURL.GET_MEMBERS ,
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equalsIgnoreCase("No Results Found.")){
                            ...
                            List<AllMember> items = new Gson().fromJson(response, new TypeToken<List<AllMember>>() {
                            }.getType());
                            cList.clear();
                            cList.addAll(items);
